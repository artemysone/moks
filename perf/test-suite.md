...
Speed up the `packages/cli` test suite without reducing coverage or hiding failures.
...
`packages/cli/test/**`, test fixtures, package test scripts, and implementation setup paths only when a benchmarked bottleneck points there.
