...
| Slash | Kind | Does |
|---|---|---|
| `/init` | Agent | Company dossier intake. Scaffolds company `HIRING.md` if missing, then interviews for who they are, how they hire, bar, tone, policy. Never creates a req, even with a title. |
