...
- [Operator path](./operator-path.md) chains the recruiter loop on a fresh multi-req company: `/init`, `/open-req`, `pull` projecting cards into the focused req, ledger verbs from the company root.
