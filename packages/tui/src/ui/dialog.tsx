...
import { useBindings, useMoksModeStack } from "../keymap"
...
function init() {
  ...
  const renderer = useRenderer()
  const modeStack = useMoksModeStack()
  ...
  return (
    <ctx.Provider value={value}>
      ...
      <box
        ...
        onMouseUp={!Flag.MOKS_EXPERIMENTAL_DISABLE_COPY_ON_SELECT ? copySelection : undefined}
      >
