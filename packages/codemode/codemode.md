...
This is the living design and status document for `@moks/codemode` and its existing engine adapter. "V2" in import paths is a leftover OpenCode name, not a second product.
