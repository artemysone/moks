...
Practical reference for the current tool-migration state in `packages/moks`.
...
Tool tests should use the existing Effect helpers in `packages/moks/test/lib/effect.ts`:
