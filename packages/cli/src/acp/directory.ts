...
export class Loader extends Context.Service<Loader, LoaderInterface>()("@moks/ACPDirectoryLoader") {}

export class Service extends Context.Service<Service, Interface>()("@moks/ACPDirectory") {}
