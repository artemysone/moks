...
import type { AssistantMessage, Message, OpencodeClient, SessionMessageResponse } from "@moks/sdk/v2"
...
export class Service extends Context.Service<Service, Interface>()("@moks/ACP/Service") {}
