...
import type * as SDK from "@moks/sdk/v2"
...
import { SessionShareTable } from "@moks/core/share/sql"
...
export class Service extends Context.Service<Service, Interface>()("@moks/ShareNext") {}
