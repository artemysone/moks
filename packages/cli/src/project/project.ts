...
import { ProjectDirectoryTable, ProjectTable } from "@moks/core/project/sql"
import { ProjectDirectories } from "@moks/core/project/directories"
...
import { which } from "@moks/core/util/which"
...
export class Service extends Context.Service<Service, Interface>()("@moks/Project") {}
...
const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const fakeVcs = Schema.decodeUnknownSync(Schema.optional(Project.Vcs))(Flag.MOKS_FAKE_VCS)
