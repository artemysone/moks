import type { JsonSchema, LLMRequest, ProviderMetadata } from "@moks/llm"
import { LLM, Message, SystemPart, ToolCallPart, ToolDefinition, ToolResultPart } from "@moks/llm"
import {
  AmazonBedrock,
  Anthropic,
  Azure,
...
export const request = (input: RequestInput) => {
  ...
  // @moks/llm request objects from opencode's session/AI SDK-shaped data.
  return LLM.request({
