...
import { buildPrompt } from "@moks/core/session/compaction"
import { SessionCompactionEvent } from "@moks/schema/session-compaction-event"
...
export class Service extends Context.Service<Service, Interface>()("@moks/SessionCompaction") {}
