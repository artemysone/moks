...
import { ConfigMCPV1 } from "@moks/core/v1/config/mcp"
...
import { McpEvent } from "@moks/schema/mcp-event"
...
export class Service extends Context.Service<Service, Interface>()("@moks/MCP") {}
