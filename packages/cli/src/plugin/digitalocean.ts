...
import type { Model } from "@moks/sdk/v2"
import { InstallationVersion } from "@moks/core/installation/version"
import { OauthCallbackPage } from "@moks/core/oauth/page"
      ...
      methods: [
        {
          ...
          async authorize() {
            ...
            return {
              url,
              instructions:
                "Sign in to DigitalOcean in your browser. moks will use your DigitalOcean API token directly for inference and load your Inference Routers. Re-run /providers to refresh routers later.",
