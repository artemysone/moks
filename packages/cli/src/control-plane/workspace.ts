...
import { EventSequenceTable, EventTable } from "@moks/core/event/sql"
...
import { WorkspaceEvent } from "@moks/schema/workspace-event"
...
export class Service extends Context.Service<Service, Interface>()("@moks/Workspace") {}
