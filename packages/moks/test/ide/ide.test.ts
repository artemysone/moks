...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders MOKS_CALLER", () => {
    process.env["MOKS_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode MOKS_CALLER", () => {
    process.env["MOKS_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown MOKS_CALLER", () => {
    process.env["MOKS_CALLER"] = "unknown"
