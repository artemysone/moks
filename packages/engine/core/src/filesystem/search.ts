...
export class Service extends Context.Service<Service, Interface>()("@moks/v2/FileSystem/Search") {}
...
const layer = Layer.unwrap(Effect.sync(() => (Flag.MOKS_DISABLE_FFF || !Fff.available() ? ripgrepLayer : fffLayer)))
