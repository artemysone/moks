...
import { FileSystemWatcher } from "@moks/schema/filesystem-watcher"
...
declare const MOKS_LIBC: string | undefined
...
const watcher = lazy((): typeof import("@parcel/watcher") | undefined => {
  try {
    const libc = typeof MOKS_LIBC === "undefined" ? undefined : MOKS_LIBC
...
export class Service extends Context.Service<Service, Interface>()("@moks/v2/FileWatcher") {}

const layer = Layer.effect(
  Service,
  Effect.gen(function* () {
    if (yield* Flag.MOKS_EXPERIMENTAL_DISABLE_FILEWATCHER) return Service.of({})
    ...
    if (location.vcs && (yield* Flag.MOKS_EXPERIMENTAL_FILEWATCHER)) {
