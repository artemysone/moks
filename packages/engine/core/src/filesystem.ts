...
import { Entry, FileSystem, FindInput, Match } from "@moks/schema/filesystem"
export { Entry, Match, Submatch } from "@moks/schema/filesystem"
...
export class Service extends Context.Service<Service, Interface>()("@moks/v2/FileSystem") {}
