...
import { Event } from "@moks/schema/project-directories"
import { ProjectCopy } from "@moks/schema/project-copy"
...
export class Service extends Context.Service<Service, Interface>()("@moks/ProjectCopy") {}
