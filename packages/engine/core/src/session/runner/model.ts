...
import { type Model } from "@moks/llm"
import * as AnthropicMessages from "@moks/llm/protocols/anthropic-messages"
import * as OpenAICompatibleChat from "@moks/llm/protocols/openai-compatible-chat"
import * as OpenAIResponses from "@moks/llm/protocols/openai-responses"
import { Auth, type AnyRoute } from "@moks/llm/route"
...
export class Service extends Context.Service<Service, Interface>()("@moks/v2/SessionRunnerModel") {}
