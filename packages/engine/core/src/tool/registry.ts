...
import { ToolOutput, type ToolCall, type ToolDefinition, type ToolResultValue } from "@moks/llm"
...
export class Service extends Context.Service<Service, Interface>()("@moks/v2/ToolRegistry") {}
