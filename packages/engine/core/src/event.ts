...
import { Event } from "@moks/schema/event"
import type { Data, Definition, Payload } from "@moks/schema/event"
...
import { Durable } from "@moks/schema/durable-event-manifest"

export const ID = Event.ID
export type ID = import("@moks/schema/event").ID
export type { Data, Definition, Payload } from "@moks/schema/event"
...
export class Service extends Context.Service<Service, Interface>()("@moks/Event") {}
