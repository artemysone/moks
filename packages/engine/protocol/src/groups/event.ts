...
import { EventManifest } from "@moks/schema/event-manifest"
import { Location } from "@moks/schema/location"
import type { Definition } from "@moks/schema/event"
...
export const MoksEvent = event.schema
export type MoksEvent = typeof MoksEvent.Type
export type MoksEventEncoded = typeof MoksEvent.Encoded
