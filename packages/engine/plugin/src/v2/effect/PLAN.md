...
- Effect plugins import `@moks/plugin/v2/effect`, not `@moks/core`.
- Public domain values use generated `@moks/sdk` types.
...
- Define `PluginHost` domain capabilities in `@moks/plugin/v2/effect`.
