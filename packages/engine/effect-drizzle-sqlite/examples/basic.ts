...
class Database extends Context.Service<Database, DatabaseShape>()("@moks/example/Database") {
...
class UserStore extends Context.Service<UserStore, UserStoreShape>()("@moks/example/UserStore") {
